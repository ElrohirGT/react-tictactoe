...
function Board(props) {
    let renderSquare = (i) => <Square value={props.squares[i]} index={i} onClick={props.squareClick}/>;
    return (
        <div>
  ...
  class Game extends React.Component {
    ...
    squareClick(i) {
        ...
        if (newCurrentState.squares[i] !== null)
            return;
        ...
        const history = this.state.history.slice(0, indexOfState + 1).concat([newCurrentState])
        this.setState({
